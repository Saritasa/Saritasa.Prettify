...
var StorageImpl = (function () {
    ...
    StorageImpl.prototype.getFileList = function (path, persistence, index, count) {
        persistence = (persistence === null || typeof persistence === "undefined") ? 1 /* temporary */ : persistence;
        index = index || 0;
        count = count || 0;
...
registerModule("plugin.host.perfanalytics", function () {
    return new PerfAnalyticsImpl(window.external);
});
/// <reference path="plugin.host.common.d.ts" />
var SQMAnalyticsImpl = (function () {
    function SQMAnalyticsImpl() {
        this.sqmObject = Microsoft.Plugin.Utilities.JSONMarshaler.attachToPublishedObject("Plugin.SQMAnalytics");
    }
...
(function (Microsoft) {
    ...
    })(Microsoft.Plugin || (Microsoft.Plugin = {}));
    var Plugin = Microsoft.Plugin;
})(Microsoft || (Microsoft = {}));
    ...
    (function (Plugin) {
        (function (Theme) {
            ...
            host.addEventListener("themeinitialize", function (eventArgs) {
                ...
                updateTheme(eventArgs.themeMap, true, isCurrentThemeHighContrast).then(function () {
            ...
            host.addEventListener("themechanged", function (eventArgs) {
                isCurrentThemeHighContrast = eventArgs.isHighContrastTheme;
                updateTheme(eventArgs.themeMap, false, isCurrentThemeHighContrast).then(function () {
            ...
            function processCSSFileForThemeing(path) {
                return host.getCssFile(path, false).then(function (contents) {
            ...
            (function (_cssHelpers) {
                function processCssFileContents(href, targetDoc, refNode, fireThemeReady, isHighContrast, additionalAttributes) {
                    ...
                    /// </param>
                    return host.getCssFile(href, true).done(function (contents) {
                        /// <summary>
...
(function (Microsoft) {
    (function (Plugin) {
        ...
        })(Plugin.PerfAnalytics || (Plugin.PerfAnalytics = {}));
        var PerfAnalytics = Plugin.PerfAnalytics;
    })(Microsoft.Plugin || (Microsoft.Plugin = {}));
    var Plugin = Microsoft.Plugin;
})(Microsoft || (Microsoft = {}));
var Microsoft;
    ...
    (function (Plugin) {
        (function (SQMAnalytics) {
            ...
            function isNumberSQMDataSizeCompatible(num) {
                // NOTE: This is only half the valid uint range, but due to a quirk in the VS marhshalling layer we can't deal with values over
                // Int32.MaxValue reliably. It is too risky to change the marhsalling layer to do the right thing now, and by allowing the full
                // range we allow SQM code in JS that could work fine in F12 and break in VS, possibly corrupting your SQM stream, which is very
                // bad for telemetry (i.e. having broken data, possibly without knowing you do).
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    if (type !== "string" && type !== "boolean") {
                        if (type !== "number") {
                            ...
                            throw new Error(Microsoft.Plugin.Resources.getErrorString("JSPlugin.8001"));
                        } else if (!isNumberSQMDataSizeCompatible(data[i])) {
                            throw new Error(Microsoft.Plugin.Resources.getErrorString("JSPlugin.8002"));
                        }
                    }
                }
            }
            ...
            function logNumericData(dataPointId, data) {
                if (!isNumberIntegral(data)) {
                    throw new Error(Microsoft.Plugin.Resources.getErrorString("JSPlugin.8005"));
                }
            ...
            function logStringData(dataPointId, data) {
                if (!data) {
                    throw new Error(Microsoft.Plugin.Resources.getErrorString("JSPlugin.8007"));
                }
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFKLrKEAG95BI
// SIG // D323KTajzLY2kg9MoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWB